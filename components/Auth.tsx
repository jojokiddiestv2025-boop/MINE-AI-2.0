  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-6 md:p-12 animate-billion relative">
      ...
      <div className="w-full max-w-2xl glass-premium p-12 md:p-24 rounded-[5rem] shadow-[0_100px_200px_rgba(0,0,0,1)] relative overflow-hidden">
        <div className={`absolute top-0 right-0 w-64 h-64 blur-[100px] pointer-events-none ${mode === 'school' ? 'bg-purple-600/10' : 'bg-cyan-600/10'}`}></div>
        
        <div className="flex flex-col items-center mb-16 relative z-10 text-center">
          <div className="scale-90 mb-8">
            <Logo size="md" showText={false} />
          </div>
          <h2 className="text-4xl md:text-5xl font-outfit font-black tracking-tighter text-white uppercase leading-none">
            {mode === 'school' ? 'MINE SCHOOLS' : 'MINE PERSONAL'}
          </h2>
          <p className="text-gray-500 mt-6 uppercase tracking-[0.6em] text-[10px] font-black">
        ...
        <div className="space-y-10 relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-4">
              <label className="block text-[11px] font-black uppercase tracking-[0.6em] text-gray-600 px-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`button-billion w-full text-lg py-7 ${mode === 'school' ? 'shadow-[0_0_40px_rgba(112,0,255,0.3)]' : ''}`}
            >
              {isLoading ? (
